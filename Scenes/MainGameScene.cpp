...
#define MAIN_GAME_SCENE_SCREEN_TOTAL_X 80
#define MAIN_GAME_SCENE_SCREEN_TOTAL_Y 40
...
{
    int start_draw_x = (getmaxx(stdscr) / 2) - (MAIN_GAME_SCENE_SCREEN_TOTAL_X / 2);
    int start_draw_y = (getmaxy(stdscr) / 2) - (MAIN_GAME_SCENE_SCREEN_TOTAL_Y / 2);
    ...
    // TODO: Need to change where the playerstarts instead of just "5, 5"
